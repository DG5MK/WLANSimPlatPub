...
% for STA to AP; parameters needed are: 
% distance, #floors, #walls, att-walls, att-floors, etas and breakpoint distance
function [PL] = pathloss_etaPL_STA_AP(TXLink,TXSTA,RXLink,all_paths,simulation)

    f = simulation.CarrierFrequency;
    d = all_paths{TXLink,TXSTA,RXLink}.distance;
    n = all_paths{TXLink,TXSTA,RXLink}.floors;
    m = all_paths{TXLink,TXSTA,RXLink}.walls;
